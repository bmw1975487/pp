...
public class MainActivity extends ComponentActivity {
    ...
    private void showCamera() {
        ...
        for(FilterType type:FilterType.catalog()){Button b=new Button(this);b.setText(type.label);b.setTextSize(10);b.setAllCaps(false);b.setTextColor(Color.WHITE);b.setPadding(dp(10),0,dp(10),0);GradientDrawable cb=new GradientDrawable();boolean world=type==FilterType.MATRIX;cb.setColor(type.neural?Color.argb(190,80,25,104):(world?Color.argb(210,0,66,24):Color.argb(175,25,27,33)));cb.setCornerRadius(dp(15));cb.setStroke(dp(1),type.neural?Color.rgb(207,112,255):(world?Color.rgb(0,255,110):Color.rgb(92,98,110)));b.setBackground(cb);b.setOnClickListener(v->{if(cameraController!=null)cameraController.setFilter(type);});LinearLayout.LayoutParams lp=new LinearLayout.LayoutParams(-2,dp(38));lp.setMargins(dp(3),0,dp(3),0);chips.addView(b,lp);}scroll.addView(chips,new HorizontalScrollView.LayoutParams(-2,dp(44)));bottom.addView(scroll,new LinearLayout.LayoutParams(-1,dp(48)));
